...
import { Employee } from '../hr-management.service';
...
export class EmployeeDialogComponent implements OnInit {
  ...
  dialogRef = inject(MatDialogRef<EmployeeDialogComponent>);
  form!: FormGroup;
  ...
  ngOnInit() {
    this.form = this.fb.group({
      ...
      salary: [this.data?.salary || 0, [Validators.min(0)]],
      hireDate: [this.data?.hireDate ? new Date(this.data.hireDate).toISOString().split('T')[0] : ''],
