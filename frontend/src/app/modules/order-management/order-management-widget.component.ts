  ...
  template: `
    <div class="orders-widget">
      <div class="widget-header-content">
        <p class="subtitle">Order fulfillment status</p>
      </div>
        ...
        <div class="widget-stats">
          <div class="stat-item primary">
            ...
            <div class="stat-info">
              ...
              <span class="stat-detail">Total placed</span>
            </div>
          </div>
          <div class="stat-item secondary">
            ...
            <div class="stat-info">
              ...
              <span class="stat-detail">Processing</span>
            </div>
          </div>
          ...
          <div class="stat-item accent">
            ...
            <div class="stat-info">
              <span class="stat-number">+{{ getTrendPercentage() }}%</span>
      ...
      <div class="widget-footer-actions">
        <div class="cta-grid">
          <button mat-flat-button class="cta-btn" (click)="openOrderManagement()">
          ...
          <button mat-flat-button class="cta-btn analytics-btn" (click)="openOrderManagement()">
