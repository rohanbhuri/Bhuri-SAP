          ...
          <ng-container matColumnDef="tracking">
            ...
            <td mat-cell *matCellDef="let designer">
              <div class="tracking-info" [matMenuTriggerFor]="historyMenu" style="cursor: pointer;">
                ...
                <div class="tracking-item" *ngIf="designer.changeLog?.length > 1" title="Last Updated At: {{ designer.updatedAt | date:'medium' }}">
                ...
                <div class="tracking-item" *ngIf="(!designer.changeLog || designer.changeLog.length <= 1) && designer.updatedBy && designer.updatedBy !== designer.createdBy" title="Updated At: {{ designer.updatedAt | date:'medium' }}">
              ...
              <mat-menu #historyMenu="matMenu">
                <div class="history-menu-container" (click)="$event.stopPropagation()">
                  ...
                  <div class="history-list">
                    ...
                    <div *ngFor="let log of designer.changeLog?.slice()?.reverse()" class="history-item-detail">
