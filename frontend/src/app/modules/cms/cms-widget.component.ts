...
@Component({
  ...
  template: `
    <div class="cms-widget">
        ...
        <div class="widget-stats">
          <div class="stat-item primary">
            ...
            <div class="stat-info">
              ...
              <span class="stat-detail">Published content</span>
            </div>
          </div>
          <div class="stat-item secondary">
            ...
            <div class="stat-info">
              ...
              <span class="stat-detail">Blog posts</span>
            </div>
          </div>
          ...
          <div class="stat-item accent">
            ...
            <div class="stat-info">
              ...
              <span class="stat-detail">Live content</span>
            </div>
          </div>
        </div>
      </div>
      <div class="widget-footer-actions">
        <div class="cta-grid">
          <button mat-flat-button class="cta-btn" (click)="navigateToPages()">
            <mat-icon>article</mat-icon>
            <span>Pages</span>
          </button>
          <button mat-flat-button class="cta-btn" (click)="navigateToBlogs()">
            <mat-icon>rss_feed</mat-icon>
            <span>Blogs</span>
          </button>
          <button mat-flat-button class="cta-btn analytics-btn" (click)="navigateToCms()">
  ...
  styles: [`
    ...
    .stat-item.tertiary { border-left: 3px solid #f44336; }
    .stat-item.accent { border-left: 3px solid #4caf50; }
  `]
})
export class CmsWidgetComponent implements OnInit {
  ...
  getPublishedCount(): number {
    ...
    return stats.pages + stats.blogs - stats.drafts;
  }
