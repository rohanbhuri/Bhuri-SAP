  ...
  template: `
    <div class="gantt-container">
      <div class="gantt-header">
        <h3>Timesheet Project Timeline</h3>
      ...
      <div class="gantt-content">
        <div class="gantt-sidebar">
          <div class="task-header">Timesheet Tasks</div>
...
export class TimesheetGanttPageComponent {
  tasks: TimesheetTask[] = [
    {
      id: '1',
  ...
  getTaskPosition(task: TimesheetTask): { left: number; width: number } {
  ...
  getTaskTooltip(task: TimesheetTask): string {
