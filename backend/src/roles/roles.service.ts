    ...
    return {
      admin: {
        ...
        permissions: [
          ...
          { module: 'users', action: ActionType.CREATE, resource: 'organization' },
          { module: 'users', action: ActionType.UPDATE, resource: 'organization' },
          { module: 'roles', action: ActionType.READ, resource: 'organization' },
          { module: 'organizations', action: ActionType.READ, resource: 'own' },
          { module: 'organizations', action: ActionType.UPDATE, resource: 'own' },
      ...
      hr_manager: {
        ...
        permissions: [
          ...
          { module: 'hr-management', action: ActionType.CREATE, resource: 'organization' },
          { module: 'hr-management', action: ActionType.UPDATE, resource: 'organization' },
          ...
          { module: 'employees', action: ActionType.CREATE, resource: 'organization' },
          { module: 'employees', action: ActionType.UPDATE, resource: 'organization' },
          { module: 'payroll', action: ActionType.READ, resource: 'organization' },
          { module: 'payroll', action: ActionType.CREATE, resource: 'organization' },
          { module: 'payroll', action: ActionType.UPDATE, resource: 'organization' },
          { module: 'users', action: ActionType.READ, resource: 'organization' },
          { module: 'reports', action: ActionType.READ, resource: 'organization' },
          { module: 'dashboard', action: ActionType.READ, resource: 'organization' }
        ]
      ...
      crm_manager: {
        ...
        permissions: [
          ...
          { module: 'crm', action: ActionType.CREATE, resource: 'organization' },
          { module: 'crm', action: ActionType.UPDATE, resource: 'organization' },
          { module: 'crm', action: ActionType.DELETE, resource: 'organization' },
          { module: 'contacts', action: ActionType.READ, resource: 'organization' },
          { module: 'contacts', action: ActionType.CREATE, resource: 'organization' },
          { module: 'contacts', action: ActionType.UPDATE, resource: 'organization' },
          { module: 'contacts', action: ActionType.DELETE, resource: 'organization' },
          { module: 'leads', action: ActionType.READ, resource: 'organization' },
          { module: 'leads', action: ActionType.CREATE, resource: 'organization' },
          { module: 'leads', action: ActionType.UPDATE, resource: 'organization' },
          { module: 'deals', action: ActionType.READ, resource: 'organization' },
          { module: 'deals', action: ActionType.CREATE, resource: 'organization' },
          { module: 'deals', action: ActionType.UPDATE, resource: 'organization' },
          { module: 'sales-management', action: ActionType.READ, resource: 'organization' },
          { module: 'sales-management', action: ActionType.CREATE, resource: 'organization' },
          { module: 'reports', action: ActionType.READ, resource: 'organization' },
          { module: 'dashboard', action: ActionType.READ, resource: 'organization' }
        ]
      },
      project_manager: {
        ...
        permissions: [
          ...
          { module: 'projects-management', action: ActionType.CREATE, resource: 'organization' },
          { module: 'projects-management', action: ActionType.UPDATE, resource: 'organization' },
          ...
          { module: 'tasks-management', action: ActionType.CREATE, resource: 'organization' },
          { module: 'tasks-management', action: ActionType.UPDATE, resource: 'organization' },
      ...
      sales_manager: {
        ...
        permissions: [
          { module: 'sales-management', action: ActionType.READ, resource: 'organization' },
          { module: 'sales-management', action: ActionType.CREATE, resource: 'organization' },
          { module: 'sales-management', action: ActionType.UPDATE, resource: 'organization' },
          { module: 'inventory-management', action: ActionType.READ, resource: 'organization' },
          { module: 'inventory-management', action: ActionType.CREATE, resource: 'organization' },
          { module: 'inventory-management', action: ActionType.UPDATE, resource: 'organization' },
          { module: 'crm', action: ActionType.READ, resource: 'organization' },
          { module: 'contacts', action: ActionType.READ, resource: 'organization' },
          { module: 'leads', action: ActionType.READ, resource: 'organization' },
          { module: 'deals', action: ActionType.READ, resource: 'organization' },
      ...
      staff: {
        ...
        permissions: [
          ...
          { module: 'users', action: ActionType.UPDATE, resource: 'own' },
          { module: 'organizations', action: ActionType.READ, resource: 'own' },
          { module: 'modules', action: ActionType.READ, resource: 'own' },
          { module: 'preferences', action: ActionType.READ, resource: 'own' },
          { module: 'preferences', action: ActionType.CREATE, resource: 'own' },
          { module: 'preferences', action: ActionType.UPDATE, resource: 'own' },
          { module: 'messages', action: ActionType.READ, resource: 'own' },
          { module: 'messages', action: ActionType.CREATE, resource: 'own' },
      ...
      form_builder: {
        ...
        permissions: [
          ...
          { module: 'form-builder', action: ActionType.CREATE, resource: 'organization' },
          { module: 'form-builder', action: ActionType.UPDATE, resource: 'organization' },
